...
var godot_connection_js_1 = require("../utils/godot_connection.js");
/**
...
exports.logTools = [
    {
        ...
        parameters: zod_1.z.object({
            ...
            level: zod_1.z.enum(['info', 'warn', 'error', 'all']).optional()
        ...
        execute: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        godot = (0, godot_connection_js_1.getGodotConnection)();
                        _g.label = 1;
                    case 1:
                        _g.trys.push([1, 3, , 4]);
