...
func _initialize_command_processors():
	...
	var log_commands = MCPServerLogCommands.new()  # Add log commands processor
	...
	log_commands._websocket_server = _websocket_server  # Set server reference
	...
	_command_processors.append(log_commands)  # Add to processor list
	...
	add_child(log_commands)  # Add as child
